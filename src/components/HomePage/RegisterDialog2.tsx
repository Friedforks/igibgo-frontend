            ...
            >
                ...
                <DialogContent>
                    <DialogContentText>
                        ...
                        the verification code in <b>15 minutes</b> to finish the
                        registration. You <b>need</b> to upload your avatar. The
                        email and password you input should be the <b>same</b>{" "}
                        as the input for last dialog. If the verification code
                        has expired, you'll need to refresh the page and
                        register again.
                    </DialogContentText>
